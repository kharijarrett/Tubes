...
//-------------------------------- END OF FOURTH PASS -------------------------------------------
	...
	public ArrayList<ArrayList<double[]>> makeTubesFromMagno(ArrayList<BufferedImage> magnoStack, String inLoc, String outLoc) {
		//Makes tube from thresholded magnostack.
		...
		for(GrayF32 magnoF: magStack){
			
			GrayS32 blobsS32 = new GrayS32(magnoF.getWidth(), magnoF.getHeight());
			GrayU8 blobsU8 = new GrayU8(magnoF.getWidth(), magnoF.getHeight());
			GrayU8 magnoFrame = new GrayU8(magnoF.getWidth(), magnoF.getHeight());
			BufferedImage magnoBI = new BufferedImage(magnoF.getWidth(), magnoF.getHeight(), BufferedImage.TYPE_3BYTE_BGR);
			
			
			ThresholdImageOps.threshold(magnoF, magnoFrame, (float) ImageStatistics.mean(magnoF), false);
			
			GrayU8 filtered = BinaryImageOps.erode8(magnoFrame, 1, null);
			BinaryImageOps.dilate8(filtered, 1, blobsU8);
			
			// Find the contour around the shapes using (null = no output)
			List<Contour> contours = BinaryImageOps.contour(blobsU8, ConnectRule.EIGHT,blobsS32);
...
//-------------------------------- END OF FOURTH PASS -------------------------------------------
	...
	@SuppressWarnings({ "unchecked", "unused", "deprecation" })
	public ArrayList<BufferedImage> makeMagno2(String vidLoc) {
	...
	public ArrayList<BufferedImage> makeThreshMagno(String vidLoc) {
		...
		ArrayList<BufferedImage> magnoStack = makeMagno2(vidLoc);
		ArrayList<BufferedImage> frames = new ArrayList<BufferedImage>();
	...
	*/
	...
	public ArrayList<BufferedImage> readVid(String inLoc){
		...
		for(int i=1; i< 200; i++){
			...
			frame.getContentPane().add(new JLabel(new ImageIcon(newFrame)));
			frame.pack();
...
//			System.out.println("just processed frame " + frames);
	...
	public static void main(String[] args) {
		...
		String inLoc = "C:/Users/Khari Jarrett/Documents/VideoProcessing-master/chris/Data/int9.mp4";						//what vid to handle? (vidLoc)
		String magnoLoc= "C:/Users/Khari Jarrett/Documents/VideoProcessing-master/chris/Magnos/virat4_magnoB.mp4"; 
		String outLoc= "C:/Users/Khari Jarrett/Documents/VideoProcessing-master/chris/MagnoFilters/int9_copy.mp4";			//where to put result? (stemLoc)
		String stemLoc2= "C:/Users/Khari Jarrett/Documents/VideoProcessing-master/chris/Magnos/virat4_outnums.mp4";			//where to put result?
		String txtLoc = "C:/Users/Khari Jarrett/Documents/VideoProcessing-master/chris/Text/virat4_tubelist.txt";
		...
		ArrayList<BufferedImage> vid = p.readVid(inLoc);
		p.writeVid(vid, outLoc);
